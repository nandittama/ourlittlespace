...
-- ============================================================
-- CLEANUP old auth-based schema (order matters)
-- Drop tables first so RLS policies no longer depend on helpers
-- ============================================================
...
-- ============================================================
-- RLS — public read/write for this intentional open website
-- ============================================================
...
-- Moods: select + insert (no update/delete needed)
...
grant select, insert on public.moods to anon, authenticated;
...
-- ============================================================
-- STORAGE — public bucket (no auth on the website)
-- Photos are intentionally publicly readable via URL.
-- ============================================================

...
import { PERSON_ONE, PERSON_TWO, STORAGE_KEY_PERSON, getPersonName } from '../config'
...
export function PersonProvider({ children }) {
  const [person, setPersonState] = useState(() => readStoredPerson())
